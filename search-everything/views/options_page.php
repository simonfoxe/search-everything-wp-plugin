<div class="wrap">
	...
	<form method="post">
	 ...
	 <td><input type="checkbox" id="research_external_results" name="research_external_results" value="yes" <?php checked($options['se_research_metabox']['external_search_enabled']); ?> /><span class="se-zem-color">&lArr; Try me. ;)</span></td>
				...
				<small><?php _e('(Autogenerated. You will need this if you are using the external results and something goes wrong and you need to contact our support.)','SearchEverything')?></small></td>
...
<?php endif; ?>
		...
		<table id="se-advanced-settings" class="widefat">
			<thead>
				<tr class="title">
					<th scope="col" class="manage-column se-col"><?php _e('Search Engine Advanced Configuration - exclusion', 'SearchEverything'); ?></th>
					<th scope="col" class="manage-column"></th>
				</tr>
			</thead>
			<tbody>
